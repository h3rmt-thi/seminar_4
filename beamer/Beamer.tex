		...
		\begin{itemize}
			\item \textbf{Gegenmaßnahmen:}
			      \begin{itemize}
				      ...
				      \item<5> IBRS (Indirection Branch Restricted Speculation)
				      ...
				      \item<5> STIBP (Single Thread Indirect Branch Predictors)
				            \customnote<5>{Kein Sharing der BPU zwischen Threads}
				            \customnote<5>{https://shorturl.at/MkOs6}
				      \item<5> IBPB (Indirect Branch Prediction Barrier)
			...
			\item \textbf{Gegenmaßnahmen:}
			      \begin{itemize}
				      \item EEC (Error-Correcting Code)
				            \customnote{Detektion und Correction, normal manachmal Detection}
				            \customnote{Ein extra Bit pro Byte}
				      \item TRR (Target Row Refresh)
				            \customnote{Automatisches Refreshen von benachbarten Zeilen bei häufigem Zugriff}
				            \customnote{Optional im DDR4 Standard, propietär}
			      \end{itemize}
		\end{itemize}
	\end{onlyenv}
